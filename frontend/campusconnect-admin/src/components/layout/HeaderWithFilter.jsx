...
const HeaderWithFilter = ({ title, filterType, setFilterType }) => {
    ...
    <div className='flex items-center justify-between'>
            ...
            <button
                ...
                {filterType !== "" ? (<> <IoCloseOutline className=" text-lg" />Clear</>) : (
                    <>
        ...
        {open && (
            ...
            {[{
                ...
                <button
                    key={type.value}
                    className={` text-[12px] px-4 py-1 rounded-lg text-nowrap ${filterType === type.value ? "text-white bg-sky-900" : "text-[13px] bg-sky-100"}`} onClick={() => {
